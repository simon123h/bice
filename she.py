...
from src.time_stepper import RungeKutta4, RungeKuttaFehlberg45
import os
import shutil
...
problem.time_stepper = RungeKuttaFehlberg45(dt=1e-3)
problem.time_stepper.error_tolerance = 1e-1
