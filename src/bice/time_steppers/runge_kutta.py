...
class RungeKuttaFehlberg45(TimeStepper):
    ...
    _b42 = -3.277196176604461e00  # -7200/2197
    _b43 = 3.320892125625853e00  # 7296/2197
    _b51 = 2.032407407407407e00  # 439/216
    _b52 = -8.000000000000000e00  # -8
    _b53 = 7.173489278752436e00  # 3680/513
    _b54 = -2.058966861598441e-01  # -845/4104
    _b61 = -2.962962962962963e-01  # -8/27
    _b62 = 2.000000000000000e00  # 2
    _b63 = -1.381676413255361e00  # -3544/2565
    ...
    def step(self, problem: "Problem") -> None:
        ...
        if eps <= self.error_tolerance:
            ...
            # if we rejected too many steps already: abort with RuntimeError
            raise RuntimeError(f"Runge-Kutta-Fehlberg time-stepper exceeded maximum number of rejected steps: {self.rejection_count}")
